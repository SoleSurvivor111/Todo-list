...
const removeEditInput = (e) => {
  ...
  if (target.className !== 'li__edit') return;
  li.querySelector('.view__lable').innerHTML = li.querySelector('.li__edit').value;
  target.remove();
};
...
const keysRemoveEditInput = (e) => {
  ...
  if (liEdit.className !== 'li__edit') return;
